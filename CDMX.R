...
attach(ConcCDMX) #this is for not writing the name of the data frame and the $ ever time

#Sort Conc according to INGCOR, FOLIOVIV, FOLIOHOG
ConcCDMX<- orderBy (~+ing_cor+folioviv+foliohog, data=ConcCDMX) #this give us the households sorted by total income

#Adding the values of the expansion FACTOR. The sum is 34 million, which is the number of households in the country.
tot_hogares<-sum(ConcCDMX$factor,to.data.frame=TRUE)
...
ConcCDMX$tam_dec<-tam_dec

# Creating Deciles of Income 

ConcCDMX$MAXT<-ConcCDMX$ing_cor #vamos a crear en esta base la variable MAXT que es una copia de la columna de ingresos

ConcCDMX<-ConcCDMX[with(ConcCDMX, order(rank(MAXT))),]  #lo que hicimos aqu? fue reordenar la base con respecto a MAXT. Cosa que en realidad, ya estaba.

ConcCDMX$ACUMULA<-cumsum(ConcCDMX$factor) #aqu? creamos una variable de suma acumulada del FACTOR de viviendas.
...
for(i in 1:9)
{
  a1<-ConcCDMX[dim(ConcCDMX[ConcCDMX$ACUMULA<tam_dec*i,])[1]+1,]$factor
  ConcCDMX<-rbind(ConcCDMX[1:(dim(ConcCDMX[ConcCDMX$ACUMULA<tam_dec*i,])[1]+1),],
                  ConcCDMX[(dim(ConcCDMX[ConcCDMX$ACUMULA<tam_dec*i,])[1]+1):dim(ConcCDMX[1])[1],])
  
  b1<-tam_dec*i-ConcCDMX[dim(ConcCDMX[ConcCDMX$ACUMULA<tam_dec*i,])[1],]$ACUMULA
  ConcCDMX[(dim(ConcCDMX[ConcCDMX$ACUMULA<tam_dec*i,])[1]+1),]$factor<-b1
  ConcCDMX[(dim(ConcCDMX[ConcCDMX$ACUMULA<tam_dec*i,])[1]+2),]$factor<-(a1-b1)
}

#aqu? estamos creando otra variable de suma acumulada del n?mero de hogares
ConcCDMX$ACUMULA2<-cumsum(ConcCDMX$factor)
...
ConcCDMX[(ConcCDMX$ACUMULA2<=tam_dec),]$DECIL<-1
...
for(i in 1:9)
{
  ConcCDMX[((ConcCDMX$ACUMULA2>tam_dec*i)&(ConcCDMX$ACUMULA2<=tam_dec*(i+1))),]$DECIL<-(i+1)
}

# a lo que le qued? cero (que es la ?ltima observaci?n), ponle el decil 10
ConcCDMX[ConcCDMX$DECIL%in%"0",]$DECIL<-10

setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/CDMX")
write.dbf(ConcCDMX,file="ConcCDMX2010.dbf")
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/CDMX")
write.dbf(ConcCDMX,file="ConcCDMX2018.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/CDMX")
Conc2010<-read.dbf("ConcCDMX2010.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "CDMX por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "CDMX por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "CDMX por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "CDMX por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "CDMX por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "CDMX INDIGENA por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "CDMX INDIGENA por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "CDMX INDIGENA por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "CDMX INDIGENA por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "CDMX INDIGENA por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "CDMX NO por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "CDMX NO por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "CDMX NO por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "CDMX NO por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "CDMX NO por fuente por DECIL LS 2010.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/CDMX")
Conc2018<-read.dbf("ConcCDMX2018.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "CDMX Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "CDMX Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "CDMX Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "CDMX Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "CDMX Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "CDMX INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "CDMX INDIGENA Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "CDMX INDIGENA Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "CDMX INDIGENA Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "CDMX INDIGENA Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "CDMX NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "CDMX NO Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "CDMX NO Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "CDMX NO Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "CDMX NO Ingresos por fuente por DECIL LS 2018.dbf")
...
Deciles2010<-read.dbf("CDMX por fuente por DECIL estimaciones 2010.dbf")
names(Deciles2010)[1]<-c("ingcor2010")

Deciles2018<-read.dbf("CDMX Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010No<-read.dbf("CDMX NO por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010No)[1]<-c("No2010")

deciles2018No<-read.dbf("CDMX NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010indigena<-read.dbf("CDMX INDIGENA por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010indigena)[1]<-c("Indigena2010")

deciles2018indigena<-read.dbf("CDMX INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
